...
public class ScoringRule implements TestRule {
    private String TEST_PREFIX = "Test"; private String testedClassName;
    private Score overallScore;
    private Map<String, List<String>> categoryToTests; private Map<String, Score> categoryToScore; private Map<String, Score> testToScore;
